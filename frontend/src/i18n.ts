  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        vip_status_active: 'Status: Active ($10/month)',
        vip_status_inactive: 'Not subscribed.',
        vip_join: 'Open VIP Telegram',
        vip_started: 'Started',
        vip_renews: 'Renews',
        vip_subscribe: 'Subscribe $10/month',
